 ...
 */
public class TurbineNetworkServerRunner implements Runnable {

    private boolean started = false;
    private static Logger logger = Logger.getLogger(TurbineNetworkServerRunner.class);
    ...
    public TurbineNetworkServerRunner(int listenPort, int maxConnections)
    {
        this.started = true;
